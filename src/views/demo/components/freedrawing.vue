<template>
	<div style="display: inline-block; margin-left: 10px">
		<el-button id="drawing-mode" class="btn btn-info" @click="drawingModeEl">{{drawingModeElTitle}}</el-button><br>
		<el-button id="clear-canvas" class="btn btn-info" @click="clearEl">Clear</el-button><br>
