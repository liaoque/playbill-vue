<template>
  <div style="display: inline-block; background: #f5f2f0; padding: 0 10px; margin-top: .5em; margin-left: 10px; margin-right: -5px">
    ...
    <p>
      <label>
        <input type="checkbox" id="hasBorders" v-model="hasBorders" @change="observeBoolean('hasBorders', hasBorders)">
    ...
    <p>
      <label>
        <input type="checkbox" id="selectable" v-model="selectable" @change="observeBoolean('selectable',selectable)">
    ...
    <p>
      <label>
        ...
        <input type="range" id="rotatingPointOffset" v-model="rotatingPointOffset" @input="rotatingPointOffsetC" min="5"
          max="150" style="display: block">
      </label>
    </p>
    <p>
    ...
    <p id="setControlVisible">
      <label v-for=" item in optionsList">
        {{item.name}}<input type="checkbox" title="top-left control" v-model="item.value"
          @change="observeOptionsList(item.name,item.value)">
      </label>
